...
imagen = load_img('../burger.jpg', color_mode='rgb', target_size=(64,64,3))
...
#    while True:
#        try:
#            if user_input_date == 'UTC' or user_input_plon == '' or user_input_plat == '' or user_input_dlon == '' or user_input_dlat=='' or user_input_numpass=='':
